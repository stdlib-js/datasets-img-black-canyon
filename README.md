...
```javascript
image = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/datasets-img-black-canyon@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/datasets-img-black-canyon@umd/bundle.js"></script>
```
